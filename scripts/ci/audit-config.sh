...

{
  ...
  echo "LuCI language zh_Hans detected: $(config_value CONFIG_LUCI_LANG_zh_Hans || true)"
  echo "LuCI base zh-cn detected: $(config_value CONFIG_PACKAGE_luci-i18n-base-zh-cn || true)"
